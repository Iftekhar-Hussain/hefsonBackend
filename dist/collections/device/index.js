 ...
 */
class DeviceClass {
  static saveDevice(payload) {
    return this(payload).save();
  }

  static saveManyDevice(payload) {
...
_dbSchema.default.loadClass(DeviceClass);

var _default = _mongoose.default.model("Devices", _dbSchema.default);
