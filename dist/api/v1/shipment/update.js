...
/**
 * @swagger
 * /api/v1/shipment/updateShipment:
 *  put:
 *   tags: ["Shipment"]
...
const shipmentSchema = _joi.default.object({
  id: _joi.default.string().label("Shipment Id"),
...
app.put("/shipment/updateShipment", validator.body(shipmentSchema, {
  joi: {
    convert: true,
    allowUnknown: false
  }
}), _universal.checkTokenCommon, _shipment.updateShipment);
var _default = app;
