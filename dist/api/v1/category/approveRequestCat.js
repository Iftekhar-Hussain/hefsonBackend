...
const Schema = _joi.default.object({
  id: _joi.default.string().trim().required().label("Request Category Id")
});
/*
...
app.put("/category/approveRequestCat", validator.body(Schema, {
  joi: {
    convert: true,
    allowUnknown: false
  }
}), _universal.checkTokenCommon, _category.approveRequestCat);
var _default = app;
