...
const Schema = _joi.default.object({
  ...
  image: _joi.default.string().trim().optional().allow("").label("Category Image")
});
/*
...
app.post("/category/request", validator.body(Schema, {
  joi: {
    convert: true,
    allowUnknown: false
  }
}), _universal.checkTokenCommon, _category.requestCat);
var _default = app;
