...
const Schema = _joi.default.object({
  ...
  threadId: _joi.default.string().required().label("Thread Id")
});
/*
...
app.get("/chat/messageListing", validator.query(Schema, {
  joi: {
    convert: true,
    allowUnknown: false
  }
}), _universal.checkTokenCommon, _chat.messageListing);
var _default = app;
