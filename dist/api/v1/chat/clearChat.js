...
const shipmentSchema = _joi.default.object({
  threadId: _joi.default.string().label("ThreadId"),
  groupId: _joi.default.string().optional().allow("").label("GroupId")
});

app.post("/chat/clearChat", validator.body(shipmentSchema, {
  joi: {
    convert: true,
    allowUnknown: false
  }
}), _universal.checkTokenCommon, _chat.clearChat);
var _default = app;
