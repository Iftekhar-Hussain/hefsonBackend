...
import TEMPALERTMODEL from "../collections/tempAlert";
import TESTINGMODEL from "../collections/test";
import LOGMODEL from "../collections/log";
  ...
  try {
    ...
    if (shipmets.length > 0) {
      ...
      for (let i = 0; i < shipmets.length; i++) {
        ...
        if (
          parseInt(
            parseInt(shipmets[i].startTime) - parseInt(currentTimeStamp)
          ) <= 7200
        ) {
...
schedule.scheduleJob("*/1 * * * *", async () => {
  try {
    ...
    let shipmentIds = shipmets
      ...
      .join(",");
    //  console.log('herrerrere adit gol',shipmentIds)
    //  return false;
    ...
    if (shipmets.length > 0) {
      for (let i = 0; i < shipmets.length; i++) {
            ...
            await SHIPMENTMODEL.findOneAndUpdate(
              { _id: mongoose.Types.ObjectId(shipmets[i]._id) },
              {
                $set: {
                  ...
                  "isShipperArrival.createdTime":
                    shipmets[i].realTimeData.FGPSTime,
                  "isShipperArrival.latitude":
                    shipmets[i].realTimeData.FLatitude,
                  "isShipperArrival.longitude":
                    shipmets[i].realTimeData.FLongitude,
                },
              }
            );
                ...
                { _id: mongoose.Types.ObjectId(shipmets[i]._id) },
                {
                  $set: {
                    ...
                    "isShipperWaiting.createdTime":
                      shipmets[i].realTimeData.FGPSTime,
                    "isShipperWaiting.latitude":
                      shipmets[i].realTimeData.FLatitude,
                    "isShipperWaiting.longitude":
                      shipmets[i].realTimeData.FLongitude,
                  },
                }
              );
        ...
        if (
          ...
          shipmets[i].isShipperLoading.status == false
        ) {
          let lightFlx = JSON.parse(
            shipmets[i].realTimeData?.FExpandProto?.FDesc
          );
          lightFlx = lightFlx.fLx;
          //  console.log('hererre in loading',JSON.parse(shipmets[i].realTimeData?.FExpandProto?.FDesc))
            ...
            await SHIPMENTMODEL.findOneAndUpdate(
              { _id: mongoose.Types.ObjectId(shipmets[i]._id) },
              {
                $set: {
                  ...
                  "isShipperLoading.createdTime":
                    shipmets[i].realTimeData.FGPSTime,
                  "isShipperLoading.latitude":
                    shipmets[i].realTimeData.FLatitude,
                  "isShipperLoading.longitude":
                    shipmets[i].realTimeData.FLongitude,
                },
              }
            );
        ...
        if (
          ...
          shipmets[i].isShipperLoadingComplete.status == false
          // && shipmets[i].isShipperCheckout.status == false
        ) {
          let lightFlx = JSON.parse(
            shipmets[i].realTimeData?.FExpandProto?.FDesc
          );
          ...
          if (lightFlx == 0) {
            await SHIPMENTMODEL.findOneAndUpdate(
              { _id: mongoose.Types.ObjectId(shipmets[i]._id) },
              {
                $set: {
                  ...
                  "isShipperLoadingComplete.createdTime":
                    shipmets[i].realTimeData.FGPSTime,
                  "isShipperLoadingComplete.latitude":
                    shipmets[i].realTimeData.FLatitude,
                  "isShipperLoadingComplete.longitude":
                    shipmets[i].realTimeData.FLongitude,
                },
              }
            );
            ...
            const FGPSTime = new Date(shipmets[i].realTimeData.FGPSTime);

            // Add 10 minutes
            FGPSTime.setMinutes(FGPSTime.getMinutes() + 10);

            // Convert the updated date and time to a string
            ...
            await SHIPMENTMODEL.findOneAndUpdate(
              { _id: mongoose.Types.ObjectId(shipmets[i]._id) },
              {
                $set: {
                  ...
                  "isShipperCheckout.latitude":
                    shipmets[i].realTimeData.FLatitude,
                  "isShipperCheckout.longitude":
                    shipmets[i].realTimeData.FLongitude,
                },
              }
            );
        ...
        if (
          ...
          shipmets[i].isShipperWaiting.status == true &&
          shipmets[i].isShipperLoading.status == true &&
          shipmets[i].isShipperLoadingComplete.status == true &&
          shipmets[i].isShipperCheckout.status == true &&
          shipmets[i].isShipperDeparture.status == false
        ) {
          let getDistanceValue = await getDistance(
            shipmets[i].shipper[0].latitude,
            shipmets[i].shipper[0].longitude,
          ...
          if (getDistanceValue >= 3) {
            await SHIPMENTMODEL.findOneAndUpdate(
              { _id: mongoose.Types.ObjectId(shipmets[i]._id) },
              {
                $set: {
                  ...
                  "isShipperDeparture.createdTime":
                    shipmets[i].realTimeData.FGPSTime,
                  "isShipperDeparture.latitude":
                    shipmets[i].realTimeData.FLatitude,
                  "isShipperDeparture.longitude":
                    shipmets[i].realTimeData.FLongitude,
                },
              }
            );
            ...
            let obj = {
              text:
                "Your shipment (" +
                shipmets[i].loadId +
                ") has been departed from the shipper end.",
              type: "shipment",
              senderId: userData._id,
        ...
        if (
          ...
          shipmets[i].isReceiverArrival.status == false
        ) {
          let getDistanceValue = await getDistance(
          ...
          if (getDistanceValue <= 0.5) {
            await SHIPMENTMODEL.findOneAndUpdate(
              { _id: mongoose.Types.ObjectId(shipmets[i]._id) },
              {
                $set: {
                  ...
                  "isReceiverArrival.createdTime":
                    shipmets[i].realTimeData.FGPSTime,
                  "isReceiverArrival.latitude":
                    shipmets[i].realTimeData.FLatitude,
                  "isReceiverArrival.longitude":
                    shipmets[i].realTimeData.FLongitude,
                },
              }
            );
                ...
                { _id: mongoose.Types.ObjectId(shipmets[i]._id) },
                {
                  $set: {
                    ...
                    "isReceiverWaiting.createdTime":
                      shipmets[i].realTimeData.FGPSTime,
                    "isReceiverWaiting.latitude":
                      shipmets[i].realTimeData.FLatitude,
                    "isReceiverWaiting.longitude":
                      shipmets[i].realTimeData.FLongitude,
                  },
                }
              );
            ...
            let obj = {
              text:
                "Your shipment (" +
                shipmets[i].loadId +
                ") has been arrived to the location.",
              type: "shipment",
              senderId: userData._id,
              receiverId: shipmets[i].carrierId,
              shipmentId: shipmets[i]._id,
            ...
            const emailData = {
              to: shipmets[i].carrierInfo.email,
              subject:
                Mail.subjects.shipment + "arrived (" + shipmets[i].loadId + ")",
              html: result.html,
              templateId: "shipment",
            };
        ...
        if (
          ...
          shipmets[i].isReceiverArrival.status == true &&
          //    shipmets[i].isReceiverCheckin.status == true &&
          shipmets[i].isReceiverWaiting.status == true &&
          shipmets[i].isReceiverUnloading.status == false
        ) {
          let lightFlx = JSON.parse(
            shipmets[i].realTimeData?.FExpandProto?.FDesc
          );
            ...
            await SHIPMENTMODEL.findOneAndUpdate(
              { _id: mongoose.Types.ObjectId(shipmets[i]._id) },
              {
                $set: {
                  ...
                  "isReceiverUnloading.createdTime":
                    shipmets[i].realTimeData.FGPSTime,
                  "isReceiverUnloading.latitude":
                    shipmets[i].realTimeData.FLatitude,
                  "isReceiverUnloading.longitude":
                    shipmets[i].realTimeData.FLongitude,
                },
              }
            );
        ...
        if (
          ...
          //     shipmets[i].isReceiverCheckin.status == true &&
          shipmets[i].isReceiverWaiting.status == true &&
          shipmets[i].isReceiverUnloading.status == true &&
          shipmets[i].isReceiverUnLoadingComplete.status == false
          //  &&  shipmets[i].isReceiverCheckout.status == false
        ) {
          let lightFlx = JSON.parse(
            shipmets[i].realTimeData?.FExpandProto?.FDesc
          );
            ...
            await SHIPMENTMODEL.findOneAndUpdate(
              { _id: mongoose.Types.ObjectId(shipmets[i]._id) },
              {
                $set: {
                  ...
                  "isReceiverUnLoadingComplete.createdTime":
                    shipmets[i].realTimeData.FGPSTime,
                  "isReceiverUnLoadingComplete.latitude":
                    shipmets[i].realTimeData.FLatitude,
                  "isReceiverUnLoadingComplete.longitude":
                    shipmets[i].realTimeData.FLongitude,
                  //  isCompleted: true,
                },
              }
            ...
            await SHIPMENTMODEL.findOneAndUpdate(
              { _id: mongoose.Types.ObjectId(shipmets[i]._id) },
              {
                $set: {
                  ...
                  "isReceiverCheckout.createdTime": updatedTime, //shipmets[i].realTimeData.FGPSTime,
                  "isReceiverCheckout.latitude":
                    shipmets[i].realTimeData.FLatitude,
                  "isReceiverCheckout.longitude":
                    shipmets[i].realTimeData.FLongitude,
                  //  isCompleted: true,
                },
              }
        ...
        if (
          ...
          shipmets[i].isReceiverWaiting.status == true &&
          shipmets[i].isReceiverUnloading.status == true &&
          shipmets[i].isReceiverUnLoadingComplete.status == true &&
          shipmets[i].isReceiverCheckout.status == true &&
          shipmets[i].isReceiverDeparture.status == false
        ) {
          let getDistanceValue = await getDistance(
            shipmets[i].receiver[0].latitude,
            shipmets[i].receiver[0].longitude,
            ...
            await SHIPMENTMODEL.findOneAndUpdate(
              { _id: mongoose.Types.ObjectId(shipmets[i]._id) },
              {
                $set: {
                  ...
                  "isReceiverDeparture.createdTime":
                    shipmets[i].realTimeData.FGPSTime,
                  "isReceiverDeparture.latitude":
                    shipmets[i].realTimeData.FLatitude,
                  "isReceiverDeparture.longitude":
                    shipmets[i].realTimeData.FLongitude,
                  isCompleted: true,
                },
              }
...
schedule.scheduleJob({ hour: 23, minute: 59 }, async () => {
  try {
    ...
    let options = await axios({
      ...
      data: {
        FTokenID: sensorToken, //"71f8dbba-37af-477b-a66b-e2e01e882939",
    ...
    await LOGMODEL.insertMany(options.data.FObject);
  } catch (err) {
    console.log("in catch erro .....................", err);
  }
});
...
schedule.scheduleJob({ hour: 23, minute: 59 }, async () => {
  try {
    let userData = await USERMODEL.findOne({ role: 1 });
    let trailers = await TRAILERMODEL.aggregate([
      {
        $match: {
          currentHours: { $gte: 2500 },
          isDeleted: false,
        },
      },
      {
    ...
    if (trailers.length > 0) {
      for (let i = 0; i < trailers.length; i++) {
        let obj = {
          text:
            "your trailer (" +
            trailers[i].unitNumber +
            ") engine has exceeded 2500 hours",
          type: "service",
          senderId: userData._id,
        ...
        const emailData = {
          ...
          subject:
            Mail.subjects.serviceHour + "(" + trailers[i].unitNumber + ")",
          html: result.html,
    ...
    if (trailers.length > 0) {
      for (let i = 0; i < trailers.length; i++) {
        ...
        var Difference_In_Time =
          trailers[i].registrationExpiry.getTime() - currentDate.getTime();
        ...
        if (diffInDays <= 5) {
          let obj = {
            text:
              "your trailer (" +
              trailers[i].unitNumber +
              ") registration is soon going to expire.",
            type: "expireTrailer",
            senderId: userData._id,
            receiverId: trailers[i].userData._id,
            trailerId: trailers[i]._id,
          ...
          const emailData = {
            to: trailers[i].userData.email,
            subject:
              Mail.subjects.expire + "Trailer (" + trailers[i].unitNumber + ")",
            html: result.html,
            templateId: "expire",
          };
...
schedule.scheduleJob({ hour: 23, minute: 59 }, async () => {
  try {
    ...
    let userData = await USERMODEL.findOne({ role: 1 });
    let trailers = await TRUCKMODEL.aggregate([
      {
        $match: {
          isDeleted: false,
        },
      ...
      for (let i = 0; i < trailers.length; i++) {
        ...
        if (diffInDays <= 5) {
          ...
          const emailData = {
            to: trailers[i].userData.email,
            subject:
              Mail.subjects.expire + "Truck (" + trailers[i].unitNumber + ")",
            html: result.html,
            templateId: "expire",
          };
...
schedule.scheduleJob({ hour: 23, minute: 59 }, async () => {
  try {
    ...
    let userData = await USERMODEL.findOne({ role: 1 });
    let trailers = await USERMODEL.aggregate([
      {
        $match: {
          isDeleted: false,
          role: 4,
    ...
    if (trailers.length > 0) {
      for (let i = 0; i < trailers.length; i++) {
        let currentDate = new Date();
        var Difference_In_Time =
          trailers[i].protfolioData.licenseExp.getTime() -
          currentDate.getTime();
        var diffInDays = (Difference_In_Time / (1000 * 3600 * 24)).toFixed(0);
        ...
        if (diffInDays <= 5) {
          let obj = {
            text:
              "your driver (" +
              trailers[i].id +
              ") license registration is soon going to expire.",
            type: "expireDriver",
            senderId: userData._id,
            receiverId: trailers[i].userData._id,
    ...
    shipmets = await Promise.all(
      shipmets.map(async (k, index) => {
        ...
        if (lightFlx > 0 && distanceValue > 3 && distanceValuereceiver > 3) {
          ...
          await ALARMMODEL.saveAlarm(alarmObj);
        ...
        if (lightFlx < 0 && distanceValue > 3 && distanceValuereceiver > 3) {
          ...
          let alaramRecord = await ALARMMODEL.find({
            type: 2,
            doorFlag: true,
            shipmentId: obj._id,
          })
          ...
          if (alaramRecord.length > 0) {
            ...
            await ALARMMODEL.findOneAndUpdate(
    ...
    shipmets = await Promise.all(
      shipmets.map(async (k, index) => {
        ...
        if (distanceValue > 3 && distanceValuereceiver > 3) {
          ...
          if (alertCount == 6) {
            console.log("herrrr in equal 6");
            //check temp for all the last 6 entries
            let notData = await TEMPALERTMODEL.find({
              shipmentId: mongoose.Types.ObjectId(obj._id),
              type: 1,
            })
              .sort({ createdAt: -1 })
            ...
            let newArray = notData.filter(function (el) {
              return (
                el.FTemperature1 > obj.temperature.max ||
                el.FTemperature1 < obj.temperature.min
              );
            });
            console.log("newArray-111", newArray);
            // return false;
            if (newArray.length == 0) {
              console.log("herrr1");
              //no alert set temp count back to 0
              await SHIPMENTMODEL.findOneAndUpdate(
                { _id: mongoose.Types.ObjectId(obj._id) },
                { tempAlertCount: 0 }
              );
...
schedule.scheduleJob("*/5 * * * *", async () => {
  ...
  try {
    ...
    let shipmets = await TRAILERMODEL.aggregate(query);
    if (shipmets.length > 0) {
      for (let i = 0; i < shipmets.length; i++) {
        let dt1 = moment().utc().format("YYYY-MM-DD HH:mm:ss");
        let dt2 = moment().utc().subtract(5, "minutes");
        ...
        await MAPDATAMODEL.insertMany(finalData);
      }
      return true;
    }
  } catch (err) {
...
schedule.scheduleJob("*/5 * * * *", async () => {
  ...
  try {
    ...
    let shipmets = await SENSORMODEL.aggregate(query);
    if (shipmets.length > 0) {
      for (let i = 0; i < shipmets.length; i++) {
        let dt1 = moment().utc().format("YYYY-MM-DD HH:mm:ss");
        let dt2 = moment().utc().subtract(5, "minutes");
        ...
        await DEVICEMAPMODEL.insertMany(finalData);
      }
      return true;
    }
  } catch (err) {
